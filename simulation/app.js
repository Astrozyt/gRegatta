...
function setBoat() {
    ...
    hull.graphics.beginFill("red").beginStroke("black").setStrokeStyle(1);
    var sail = new createjs.Shape();
    sail.graphics.beginFill("#000000");
    sail.graphics.drawRect(5, -8, 2, 12);
    var boat = new createjs.Container();
    // sail.x = boat.x - 20; 
    // sail.y = boat.y - 60;
    boat.addChild(hull, sail);
    hull.graphics.moveTo(12, 0).lineTo(6, -20).lineTo(0, 0).closePath();
    boat.regX = 6;
    boat.regY = -10;
    boat.rotation = 270;
    boat.name = "boat";
    ...
    myPath.graphics.beginStroke("black");
